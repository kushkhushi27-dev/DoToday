...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info("Initializing TaskFlow seed data...");
        ...
        // 2. Create Users
        User admin = new User("admin", "admin@taskflow.com", passwordEncoder.encode("Admin@123"), "Alex Morgan");
        ...
        User john = new User("john_dev", "john@taskflow.com", passwordEncoder.encode("User@123"), "John Developer");
        ...
        User sarah = new User("sarah_pm", "sarah@taskflow.com", passwordEncoder.encode("User@123"), "Sarah Mitchell");
        ...
        User david = new User("david_qa", "david@taskflow.com", passwordEncoder.encode("User@123"), "David QA");
