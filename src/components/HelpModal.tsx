                    ...
                    <div className="flex items-center space-x-2.5">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] text-slate-400 dark:text-slate-500">
                                Quick guide to navigating DoToday smoothly
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div className="p-6 space-y-5 text-xs">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed bg-slate-50 dark:bg-slate-800/40 p-3 rounded-xl border border-slate-100 dark:border-slate-700/60">
                            DoToday uses Google Authentication and Firestore to keep your account, projects, and tasks connected across sessions.
                        </p>
                    </div>
