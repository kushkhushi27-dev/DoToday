...
import com.dotoday.controller.rest.TaskRestController;
...
import com.dotoday.security.CustomUserDetails;
...
public class TaskRestControllerTest {
    ...
    @BeforeEach
    void setupSecurity() {
        testUser = new User("tester", "tester@dotoday.com", "pass", "Test User");
        testUser.setId(1L);
